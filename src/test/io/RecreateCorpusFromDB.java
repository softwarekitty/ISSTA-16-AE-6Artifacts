...
public class RecreateCorpusFromDB {
	// TODO - reconnect this
	// essentially we want to reload the corpus from the database,
	// proving that the LoadUtil will produce the same result from
	// the text file, which should live here and not in the inputs folder
	// (a duplicate)
	
	// also we can test LoadUtil in other ways, but that is why we have
	// this helper class with the big graveyard

}

// public static final String connectionString =
// "jdbc:sqlite:/Users/carlchapman/Documents/SoftwareProjects/tour_de_source/tools/merged/merged_report.db";
//
...
//
// HashMap<PatternEscapedPair, TreeSet<Integer>> patternProjectMM = new
// HashMap<PatternEscapedPair, TreeSet<Integer>>();
// // prepare sql
// Connection c = null;
// Statement stmt = null;
...
// // pattern
// String query = "select pattern, uniqueSourceID from RegexCitationMerged where
...
// for (Entry<PatternEscapedPair, TreeSet<Integer>> entry :
// patternProjectMM.entrySet()) {
...
//////// File dumpWithIndices = new File(BehavioralCategories.homePath,
// "projectIDPatternIDMultiMap.txt");
...
//////// }
////
//// private static String getCSV(TreeSet<RegexProjectSet> value,HashMap<String,
// Integer> patternIndexMap) {
//// StringBuilder sb = new StringBuilder();
...
//
//
//// this one just dumps patterns with their index so you can try to cluster,
// boring
...
//
//
//// build the original serialized corpus file, should build into a test
// fixture.
//// // public static void main(String[] args) throws ClassNotFoundException,
//// // IllegalArgumentException, SQLException, QuoteRuleException,
//// // PythonParsingException, IOException{
