...
public class PCRELexer extends Lexer {
	...
	public static final Set<String> namedSet = Collections
			.unmodifiableSet(new HashSet<String>(Arrays.asList("alnum", "alpha", "ascii", "blank", "cntrl", "digit",
					"graph", "lower", "print", "punct", "space", "upper", "word", "xdigit")));

	protected static final Set<String> optionSet = new HashSet<String>(
			Arrays.asList("NO_START_OPT", "UTF8", "UTF16", "UCP"));

	public static final Set<String> propertySet = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList("C",
			"Cc", "Cf", "Cn", "Co", "Cs", "L", "Ll", "Lm", "Lo", "Lt", "Lu", "L", "M", "Mc", "Me", "Mn", "N", "Nd",
			"Nl", "No", "P", "Pc", "Pd", "Pe", "Pf", "Pi", "Po", "Ps", "S", "Sc", "Sk", "Sm", "So", "Z", "Zl", "Zp",
			"Zs", "Xan", "Xps", "Xsp", "Xwd", "Arabic", "Armenian", "Avestan", "Balinese", "Bamum", "Batak", "Bengali",
			"Bopomofo", "Brahmi", "Braille", "Buginese", "Buhid", "Canadian_Aboriginal", "Carian", "Chakma", "Cham",
			"Cherokee", "Common", "Coptic", "Cuneiform", "Cypriot", "Cyrillic", "Deseret", "Devanagari",
			"Egyptian_Hieroglyphs", "Ethiopic", "Georgian", "Glagolitic", "Gothic", "Greek", "Gujarati", "Gurmukhi",
			"Han", "Hangul", "Hanunoo", "Hebrew", "Hiragana", "Imperial_Aramaic", "Inherited", "Inscriptional_Pahlavi",
			...
			"Meetei_Mayek", "Meroitic_Cursive", "Meroitic_Hieroglyphs", "Miao", "Mongolian", "Myanmar", "New_Tai_Lue",
			"Nko", "Ogham", "Old_Italic", "Old_Persian", "Old_South_Arabian", "Old_Turkic", "Ol_Chiki", "Oriya",
			"Osmanya", "Phags_Pa", "Phoenician", "Rejang", "Runic", "Samaritan", "Saurashtra", "Sharada", "Shavian",
			"Sinhala", "Sora_Sompeng", "Sundanese", "Syloti_Nagri", "Syriac", "Tagalog", "Tagbanwa", "Tai_Le",
			"Tai_Tham", "Tai_Viet", "Takri", "Tamil", "Telugu", "Thaana", "Thai", "Tibetan", "Tifinagh", "Ugaritic",
			"Vai", "Yi")));
	...
	public final void mControlChar() throws RecognitionException {
		try {
			...
			// PCRE.g:725:18: '\\\\c' ASCII
			{
				...
				mASCII();
				ASCII1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, ASCII1Start86,
						getCharIndex() - 1);
	...
	public final void mHexChar() throws RecognitionException {
		try {
			int _type = HexChar;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// PCRE.g:732:16: ( '\\\\x' ( HexDigit HexDigit | '{' HexDigit
			// HexDigit ( HexDigit )+ '}' ) )
			// PCRE.g:732:18: '\\\\x' ( HexDigit HexDigit | '{' HexDigit
			// HexDigit ( HexDigit )+ '}' )
			{
				match("\\x");

				// PCRE.g:732:24: ( HexDigit HexDigit | '{' HexDigit HexDigit (
				// HexDigit )+ '}' )
				int alt3 = 2;
	...
	public final void mCharWithProperty() throws RecognitionException {
		try {
			...
			// PCRE.g:776:27: '\\\\p{' UnderscoreAlphaNumerics '}'
			{
				...
				UnderscoreAlphaNumerics2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL,
						UnderscoreAlphaNumerics2Start460, getCharIndex() - 1);
	...
	public final void mCharWithoutProperty() throws RecognitionException {
		try {
			...
			// PCRE.g:777:27: '\\\\P{' UnderscoreAlphaNumerics '}'
			{
				...
				mUnderscoreAlphaNumerics();
				UnderscoreAlphaNumerics3 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL,
						UnderscoreAlphaNumerics3Start477, getCharIndex() - 1);
	...
	public final void mPOSIXNamedSet() throws RecognitionException {
		try {
			...
			// PCRE.g:817:24: '[[:' AlphaNumerics ':]]'
			{
				...
				mAlphaNumerics();
				AlphaNumerics4 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL,
						AlphaNumerics4Start683, getCharIndex() - 1);
	...
	public final void mPOSIXNegatedNamedSet() throws RecognitionException {
		try {
			...
			// PCRE.g:818:24: '[[:^' AlphaNumerics ':]]'
			{
				...
				mAlphaNumerics();
				AlphaNumerics5 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL,
						AlphaNumerics5Start696, getCharIndex() - 1);
	...
	public void mTokens() throws RecognitionException {
		// PCRE.g:1:8: ( Quoted | BlockQuoted | BellChar | ControlChar |
		// EscapeChar | FormFeed | NewLine | CarriageReturn | Tab | Backslash |
		// HexChar | Dot | OneDataUnit | DecimalDigit | NotDecimalDigit |
		// HorizontalWhiteSpace | NotHorizontalWhiteSpace | NotNewLine |
		// CharWithProperty | CharWithoutProperty | NewLineSequence | WhiteSpace
		...
		// | PreviousMatchInSubject | ResetStartMatch |
		// SubroutineOrNamedReferenceStartG | NamedReferenceStartK | Pipe |
		// OpenParen | CloseParen | LessThan | GreaterThan | SingleQuote |
		// Underscore | Colon | Hash | Equals | Exclamation | Ampersand | ALC |
		// BLC | CLC | DLC | ELC | FLC | GLC | HLC | ILC | JLC | KLC | LLC | MLC
		// | NLC | OLC | PLC | QLC | RLC | SLC | TLC | ULC | VLC | WLC | XLC |
		// YLC | ZLC | AUC | BUC | CUC | DUC | EUC | FUC | GUC | HUC | IUC | JUC
		// | KUC | LUC | MUC | NUC | OUC | PUC | QUC | RUC | SUC | TUC | UUC |
		// VUC | WUC | XUC | YUC | ZUC | D1 | D2 | D3 | D4 | D5 | D6 | D7 | D8 |
		// D9 | D0 | OtherChar )
		int alt6 = 125;
	...
	static final String DFA6_eotS = "\1\uffff\1\174\1\uffff\1\177\u00d3\uffff";
	static final String DFA6_eofS = "\u00d7\uffff";
	static final String DFA6_minS = "\2\0\1\uffff\1\133\172\uffff\1\72\125\uffff\1\60\2\uffff";
	static final String DFA6_maxS = "\2\uffff\1\uffff\1\133\172\uffff\1\72\125\uffff\1\172\2\uffff";
	static final String DFA6_acceptS = "\2\uffff\1\14\1\uffff\1\36\1\37\1\40\1\43\1\44\1\45\1\46\1\47\1\50\1\54"
	...
	static final String DFA6_specialS = "\1\1\1\0\u00d5\uffff}>";
	static final String[] DFA6_transitionS = { "\41\130\1\30\1\130\1\26\1\15\1\130\1\31\1\23\1\17\1\20\1\11\1\10\1\14"
			...
			+ "\46\1\47\1\50\1\51\1\52\1\53\1\54\1\55\1\56\1\57\1\60\1\61\1\62\1\63" + "\1\12\1\16\1\13\uff82\130",
