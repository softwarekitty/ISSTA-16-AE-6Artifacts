...
/**
 * maps names used by PCRE parser to integer codes (with `I_' prefix) and back,
 * then maps those integer codes to short names of two to four capitol letters,
 * and to short descriptions and LaTex verbatim examples
 * 
 * @author cc
 */
public class FeatureDictionary {
	...
	private void initializeIntToDescMap() {
		...
		intToDescMap.put(I_CC_WHITESPACE,
				"\\textbackslash t \\textbackslash n \\textbackslash r \\textbackslash v \\textbackslash f or space");
